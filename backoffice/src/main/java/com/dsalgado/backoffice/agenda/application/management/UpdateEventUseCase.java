...
public class UpdateEventUseCase {
    ...
    public UpdateEventUseCase(EventRepository eventRepository, EventPublisher eventPublisher) {
        this.eventRepository = eventRepository;
        this.eventPublisher = eventPublisher;
    }

    public EventResponse execute(String id, EventRequest request) {
        ...
        eventPublisher.publish(EventUpdated.from(event));
